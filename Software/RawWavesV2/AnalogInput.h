...
#define ADC_BITS 12	// Teensy 4.0 onboard ADC only supports 8, 10 and 12 bit resolutions. 10-bit accuracy. See Chapter 66, https://www.pjrc.com/teensy/IMXRT1060RM_rev3.pdf 
